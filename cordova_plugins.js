var cordova_plugins = {
		...
		cat : 'ad',
		name : 'AdMobPluginPro',
		intro : 'The best Plugin for AdMob, single line javascript code to display Banner and Interstitial. Any size, any position! Latest SDK for iOS and Android with Google Play Services. Compatible with Intel XDK and IBM worklight.',
		ios : true,
		android : true,
		win : false,
		price : 14.99,
	...
	'com.rjfun.cordova.plugin.admob' : {
		...
		cat : 'ad',
		name : 'AdMob Plugin',
		intro : 'The most popular AdMob Plugin for PhoneGap and Cordova, Banner and Interstitial.',
		ios : true,
		android : true,
		win : true,
		price : 12.99,
